...
sourcesIndex["sc_network"] = {"name":"","dirs":[{"name":"protocol","dirs":[{"name":"legacy_proto","files":["behaviour.rs","handler.rs","upgrade.rs"]},{"name":"sync","files":["blocks.rs","extra_requests.rs"]}],"files":["block_requests.rs","event.rs","legacy_proto.rs","light_client_handler.rs","light_dispatch.rs","message.rs","specialization.rs","sync.rs","util.rs"]}],"files":["behaviour.rs","chain.rs","config.rs","debug_info.rs","discovery.rs","error.rs","lib.rs","on_demand_layer.rs","protocol.rs","service.rs","transport.rs","utils.rs"]};
