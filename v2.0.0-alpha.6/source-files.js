...
sourcesIndex["node_bench"] = {"name":"","files":["core.rs","import.rs","main.rs"]};
...
sourcesIndex["sc_cli"] = {"name":"","dirs":[{"name":"commands","files":["build_spec_cmd.rs","check_block_cmd.rs","export_blocks_cmd.rs","import_blocks_cmd.rs","mod.rs","purge_chain_cmd.rs","revert_cmd.rs","runcmd.rs"]},{"name":"params","files":["import_params.rs","keystore_params.rs","mod.rs","network_params.rs","node_key_params.rs","pruning_params.rs","shared_params.rs","transaction_pool_params.rs"]}],"files":["arg_enums.rs","config.rs","error.rs","lib.rs","runner.rs"]};
...
sourcesIndex["sc_network"] = {"name":"","dirs":[{"name":"protocol","dirs":[{"name":"generic_proto","dirs":[{"name":"handler","files":["group.rs","legacy.rs","notif_in.rs","notif_out.rs"]},{"name":"upgrade","files":["collec.rs","legacy.rs","notifications.rs"]}],"files":["behaviour.rs","handler.rs","upgrade.rs"]},{"name":"sync","files":["blocks.rs","extra_requests.rs"]}],"files":["block_requests.rs","event.rs","generic_proto.rs","light_client_handler.rs","message.rs","sync.rs","util.rs"]},{"name":"service","files":["out_events.rs"]}],"files":["behaviour.rs","chain.rs","config.rs","debug_info.rs","discovery.rs","error.rs","lib.rs","network_state.rs","on_demand_layer.rs","protocol.rs","service.rs","transport.rs","utils.rs"]};
...
sourcesIndex["sc_service"] = {"name":"","files":["builder.rs","chain_ops.rs","config.rs","error.rs","lib.rs","metrics.rs","status_sinks.rs","task_manager.rs"]};
