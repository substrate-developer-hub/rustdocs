...
implementors["libp2p_secio"] = [{"text":"impl <a class=\"trait\" href=\"https://doc.rust-lang.org/nightly/std/error/trait.Error.html\" title=\"trait std::error::Error\">Error</a> for <a class=\"enum\" href=\"libp2p_secio/enum.SecioError.html\" title=\"enum libp2p_secio::SecioError\">SecioError</a>","synthetic":false,"types":["libp2p_secio::error::SecioError"]}];
...
implementors["netstat2"] = [{"text":"impl <a class=\"trait\" href=\"https://doc.rust-lang.org/nightly/std/error/trait.Error.html\" title=\"trait std::error::Error\">Error</a> for <a class=\"enum\" href=\"netstat2/error/enum.Error.html\" title=\"enum netstat2::error::Error\">Error</a>","synthetic":false,"types":["netstat2::types::error::Error"]}];
...
implementors["platforms"] = [{"text":"impl Error for Error","synthetic":false,"types":[]}];
implementors["procfs"] = [{"text":"impl <a class=\"trait\" href=\"https://doc.rust-lang.org/nightly/std/error/trait.Error.html\" title=\"trait std::error::Error\">Error</a> for <a class=\"enum\" href=\"procfs/enum.ProcError.html\" title=\"enum procfs::ProcError\">ProcError</a>","synthetic":false,"types":["procfs::ProcError"]}];
...
implementors["protobuf"] = [{"text":"impl <a class=\"trait\" href=\"https://doc.rust-lang.org/nightly/std/error/trait.Error.html\" title=\"trait std::error::Error\">Error</a> for <a class=\"enum\" href=\"protobuf/error/enum.ProtobufError.html\" title=\"enum protobuf::error::ProtobufError\">ProtobufError</a>","synthetic":false,"types":["protobuf::error::ProtobufError"]}];
...
implementors["rlp"] = [{"text":"impl Error for DecoderError","synthetic":false,"types":[]}];
...
implementors["substrate_wasmtime"] = [{"text":"impl <a class=\"trait\" href=\"https://doc.rust-lang.org/nightly/std/error/trait.Error.html\" title=\"trait std::error::Error\">Error</a> for <a class=\"struct\" href=\"substrate_wasmtime/struct.Trap.html\" title=\"struct substrate_wasmtime::Trap\">Trap</a>","synthetic":false,"types":["substrate_wasmtime::trap::Trap"]}];
...
implementors["wabt"] = [{"text":"impl <a class=\"trait\" href=\"https://doc.rust-lang.org/nightly/std/error/trait.Error.html\" title=\"trait std::error::Error\">Error</a> for <a class=\"enum\" href=\"wabt/script/enum.Error.html\" title=\"enum wabt::script::Error\">Error</a>","synthetic":false,"types":["wabt::script::Error"]},{"text":"impl <a class=\"trait\" href=\"https://doc.rust-lang.org/nightly/std/error/trait.Error.html\" title=\"trait std::error::Error\">Error</a> for <a class=\"struct\" href=\"wabt/struct.Error.html\" title=\"struct wabt::Error\">Error</a>","synthetic":false,"types":["wabt::Error"]}];
